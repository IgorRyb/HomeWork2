...
public class CatTest {
    ...
    public void outputResult() {
        int allTests = numberOfFailedTests + numberOfSuccessfulTests;
        System.out.println("Количество удачных тестов: " + numberOfSuccessfulTests + ", Количество неудачных тестов: "
                + numberOfFailedTests + ", Всего тестов: " + allTests);
    }
}
